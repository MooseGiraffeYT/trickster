...
class PlayState extends MusicBeatState
{
	...
	// tricky lines
	public var TrickyLinesSing:Array<String> = ["MELON","GRAPE", "CAKE", "CHOCOLATE", "BOB", "BOSIP", "HUNGRY", "GIRAFFE", "READY", "TRICKY", "TIKY", "FNF", "GIRAFFES"];
	public var ExTrickyLinesSing:Array<String> = ["YOU AREN'T JAYDYN", "WHERE IS MOOSE", "MOOSE???", "WHO ARE YOU", "GIVE ME GRAPES!", "I'M HUNGRY", "BOY", "LOOK BEHIND YOU", "GIRAFFE MP4?????"];
